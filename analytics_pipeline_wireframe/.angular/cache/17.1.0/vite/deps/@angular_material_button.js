...
var _MatButtonLazyLoader = class _MatButtonLazyLoader {
  constructor() {
...
_MatButtonLazyLoader.ɵfac = function MatButtonLazyLoader_Factory(t) {
  return new (t || _MatButtonLazyLoader)();
};
_MatButtonLazyLoader.ɵprov = ɵɵdefineInjectable({
  token: _MatButtonLazyLoader,
  factory: _MatButtonLazyLoader.ɵfac,
  providedIn: "root"
});
var MatButtonLazyLoader = _MatButtonLazyLoader;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(MatButtonLazyLoader, [{
    type: Injectable,
    args: [{
      providedIn: "root"
    }]
