...
} from "./chunk-SCU66PMJ.js";
import {
  TemplatePortal
} from "./chunk-5HMONC4F.js";
import "./chunk-X27WVKA7.js";
import {
  UniqueSelectionDispatcher
} from "./chunk-3PVP74AF.js";
import {
  DOWN_ARROW,
  Directionality,
  ENTER,
  ...
  _backArrowPressed(event) {
    ...
    if (this._menuStack.hasInlineMenu() || this._menuStack.length() > 1) {
      ...
      this._menuStack.close(parentMenu, {
        focusNextOnEmpty: this._menuStack.inlineMenuOrientation() === "horizontal" ? 1 : 2,
        focusParentTrigger: true
      });
    }
  }
...
_CdkMenuItem.ɵdir = ɵɵdefineDirective({
  ...
  inputs: {
    disabled: [InputFlags.None, "cdkMenuItemDisabled", "disabled"],
...
_CdkMenuItemSelectable.ɵdir = ɵɵdefineDirective({
  ...
  inputs: {
    checked: [InputFlags.None, "cdkMenuItemChecked", "checked"]
  },
  features: [ɵɵInheritDefinitionFeature]
});
...
_CdkContextMenuTrigger.ɵdir = ɵɵdefineDirective({
  ...
  inputs: {
    ...
    disabled: [InputFlags.None, "cdkContextMenuDisabled", "disabled"]
  },
  outputs: {
